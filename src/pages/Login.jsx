...
const Login = ({ onLogin }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Fake authentication delay to match the old behavior
        setTimeout(() => {
                ...
                <div className="text-center md:text-left space-y-4 md:space-y-8 md:pl-8 lg:pl-16">
                    ...
                    <div className="space-y-2 md:space-y-4 lg:space-y-6">
                        <div className="space-y-1 md:space-y-2">
                            <div className="font-semibold text-text-primary text-sm md:text-base lg:text-lg">Marketing OS Dashboard</div>
                        ...
                        <p className="text-[#111834] text-xs md:text-sm lg:text-base leading-relaxed max-w-md mx-auto md:mx-0 opacity-70 hidden md:block">
                            Transform your marketing data into actionable intelligence. Access your marketing command center to manage your business with real-time insights.
                        </p>
                    </div>
